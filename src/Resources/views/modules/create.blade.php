    ...
    <form action="{{ route('admin.module.create') }}" method="post">
             ...
             <div class="row">
                <div class="col-md-4 col-xs-12">
                    ...
                    <x-teckiproadmin::backend.form-group-text value="{{ old('module_name') }}" name="module_name"  label="Module Name *"></x-teckiproadmin::backend.form-group-text>
                </div>

                <div class="col-md-4 col-xs-12">
                    <x-teckiproadmin::backend.form-group-text value="{{ old('route') }}" name="route" label="Route" placeholder="{{ __('Enter route path') }}"></x-teckiproadmin::backend.form-group-text>
                </div>

                <div class="col-md-4 col-xs-12">
                  <x-teckiproadmin::backend.form-group-text value="{{ old('add_ons_id') }}" name="add_ons_id" label="Add-on ID" placeholder="{{ __('Enter Add-on ID') }}"></x-teckiproadmin::backend.form-group-text>
                </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <x-teckiproadmin::backend.textarea name="extra_text" label="Extra Text" >{{ old('extra_text') ?? '' }} </x-teckiproadmin::backend.textarea>
              </div>
            </div>
                    ...
                    <label for="visible" ><i class="fas fa-hand-holding-usd"></i>Limit Enabled </label>
                      ...
                      <div class="form-group">
                        ...
                        <label class="custom-switch mt-2">
                          <input type="checkbox" name="limit_enabled"  class="custom-switch-input" {{ old('limit_enabled')=='1' ? 'checked' : '' }}>
                  ...
                  <div class="form-group" id="highlight_container">
                    <label for="highlight" ><i class="far fa-lightbulb"></i>Bulk Limit Enabled </label>
                      ...
                      <div class="form-group">
                        ...
                        <label class="custom-switch mt-2">
                          <input type="checkbox" name="bulk_limit_enabled" class="custom-switch-input" {{ old('bulk_limit_enabled')=='1' ? 'checked' : '' }}>
                          <span class="custom-switch-indicator"></span>
                          <span class="custom-switch-description">Yes</span>
