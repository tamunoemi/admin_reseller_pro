                    ...
                    <div class="card mb-4 border-0">
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="form__radios">
                                          <div class="form__radio">
                                            <label for="paddle">
                                               <img class="vendorimg"  src="{{ asset('vendor/package-dep/checkout/paddle.png') }}">
                                                Paddle</label>
                                            <input  id="paddle" x-model="payment_method" value="1" name="payment-method" type="radio" />
                                          </div>
                                          ...
                                          <div class="form__radio">
                                            <label for="stripe">
                                                ...
                                                Stripe</label>
                                            <input id="stripe" x-model="payment_method"  name="payment-method"  value="0" type="radio" />
                                          </div>
                            ...
                            <br><br>
                             ...
                             <div x-show="payment_method === '1'" >
                               <h4>Paddle</h4>


                               <x-teckiproadmin::plans.paddle :details="$details" :pid="$paddleId" :payLink="$paddlePayLink"></x-teckiproadmin::plans.paddle>

                             </div>

                             <div x-show="payment_method === '0'">
                                <h4>Stripe</h4>
                                <x-teckiproadmin::plans.stripe></x-teckiproadmin::plans.stripe>
                             </div>
