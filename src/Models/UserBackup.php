...
class User extends Authenticatable implements MustVerifyEmail,TwoFactorAuthenticatable
{
    ...
    use  CustomPlanManager,PaddleBillable,StripeBillable {
        ...
        PaddleBillable::newSubscription insteadof CustomPlanManager,StripeBillable;
        PaddleBillable::subscriptions insteadof CustomPlanManager,StripeBillable;
        PaddleBillable::subscription insteadof CustomPlanManager,StripeBillable;
        PaddleBillable::subscribed insteadof CustomPlanManager,StripeBillable;

        /** Using paddle over stripe where their are similar function names */
