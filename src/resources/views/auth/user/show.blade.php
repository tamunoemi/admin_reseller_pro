...
@section('content')
    <x-teckiproadmin::backend.card>
        ...
        <x-slot name="headerActions">
            <x-teckiproadmin::utils.link class="card-header-action" :href="route('admin.auth.user.index')" :text="__('Back')" />
        </x-slot>
        ...
        <x-slot name="body">
            <table class="table table-hover">
                <tr>
                    <th>@lang('Type')</th>
                    <td>@include('teckiproadmin::auth.user.includes.type')</td>
                </tr>
                ...
                <tr>
                    <th>@lang('Status')</th>
                    <td>@include('teckiproadmin::auth.user.includes.status', ['user' => $user])</td>
                </tr>

                <tr>
                    <th>@lang('Verified')</th>
                    <td>@include('teckiproadmin::auth.user.includes.verified', ['user' => $user])</td>
                </tr>

                <tr>
                    <th>@lang('2FA')</th>
                    <td>@include('teckiproadmin::auth.user.includes.2fa', ['user' => $user])</td>
                </tr>
